...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='crudview',
            name='map_style',
            field=django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=dict, help_text='Custom mapbox style for this entry'),
        ),
        migrations.AlterField(
            model_name='crudview',
            name='name',
        ...
        migrations.AlterField(
            model_name='crudview',
            name='ui_schema',
            field=django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=dict, help_text='Custom ui:schema style for this entry. https://react-jsonschema-form.readthedocs.io/en/latest/form-customization/'),
        ),
    ]
