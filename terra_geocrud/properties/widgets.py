...
from terra_geocrud.properties.files import get_storage_file_url, generate_storage_file_path
    ...
    def render(self):
        if self.value:
            ...
            for key, v in attrs.items():
                final_attrs += f' {key}="{v}"'
            storage_file_path = generate_storage_file_path(self.property, self.value, self.feature)
